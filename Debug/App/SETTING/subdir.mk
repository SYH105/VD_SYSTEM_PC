...
C_SRCS += \
../App/SETTING/settings.c 

OBJS += \
./App/SETTING/settings.o 

C_DEPS += \
./App/SETTING/settings.d 


# Each subdirectory must supply rules for building sources it contributes
App/SETTING/%.o App/SETTING/%.su App/SETTING/%.cyclo: ../App/SETTING/%.c App/SETTING/subdir.mk
...
clean: clean-App-2f-SETTING

clean-App-2f-SETTING:
	-$(RM) ./App/SETTING/settings.cyclo ./App/SETTING/settings.d ./App/SETTING/settings.o ./App/SETTING/settings.su

.PHONY: clean-App-2f-SETTING
